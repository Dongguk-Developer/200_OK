  ...
  goodBad: [
    {
      ...
      bad: '신청 절차가 너무 복잡했어요',
      children:
        '대학생 작학 지원 사업은 등록금 부담을 줄이고 학업에 집중할 수 있도록 돕는 정책입니다.',
    },
    {
      title: '시설 개선',
...
const generateRandomCards = (count) => {
  ...
  for (let i = 0; i < count; i++) {
    const randomType = cardTypes[i % 3];
    const randomData =
      dummyData[randomType][Math.floor(Math.random() * dummyData[randomType].length)];
